        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src="/icon.svg?v=2" alt="MailWeaver" className="h-8 w-8"/>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/campaigns" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Campaigns</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/why-us" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Why us?</a></li>
              <li><a href="https://github.com/farzanfa/bulk-mail-app" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Open Source</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/privacy" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Privacy Policy</a></li>
              <li><a href="/terms" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Terms & Conditions</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-gray-900 font-medium px-5 py-2.5 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105"
            >
