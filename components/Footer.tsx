export default function Footer() {
  return (
    <footer className="border-t bg-white mt-12">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-5 sm:py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm w-full">
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <p className="text-gray-600">© {new Date().getFullYear()} MailWeaver. All rights reserved.</p>
