    ...
    <header className={`sticky top-0 z-40 border-b bg-white/95 backdrop-blur-sm transition-all duration-300 ${scrolled ? 'shadow-sm' : ''} safe-padding-top`}>
          ...
          <div className="flex min-w-0 items-center justify-between h-14 sm:h-16 gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              {isMarketing ? (
                <>
                  ...
                  <a
                    ...
                    className="hidden lg:inline-flex items-center gap-2 rounded-lg text-sm px-3 py-2 bg-[#24292f] text-white hover:bg-[#1c2128] transition-colors duration-200"
                  >
              ...
              <button 
                ...
                className="md:hidden inline-flex items-center justify-center p-1.5 rounded-lg hover:bg-gray-100 transition-colors duration-200 touch-target flex-shrink-0" 
      ...
      {open && (
        <>
          {/* Mobile Menu Overlay */}
          <div 
            className="md:hidden fixed inset-0 z-50 bg-black/40 backdrop-blur-sm mobile-menu-overlay"
          ...
          <div 
            ...
            role="dialog"
            aria-modal="true"
            className="md:hidden fixed left-0 top-0 h-full w-[280px] max-w-[75vw] bg-white shadow-xl z-50 flex flex-col overflow-hidden"
