...
export default function BillingClient({ userEmail }: BillingClientProps) {
  ...
  const [activeTab, setActiveTab] = useState<'subscription' | 'history' | 'upgrade'>('subscription');
  ...
  const fetchBillingData = async () => {
    try {
      const [subResponse, usageResponse, paymentResponse, paymentsResponse] = await Promise.all([
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to cancel your subscription? You'll continue to have access to your current plan until {subscription && format(new Date(subscription.current_period_end), 'MMMM d, yyyy')}.
                      </p>
