...
export default function HomeClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 space-y-20">
      ...
      <section className="text-center py-16 animate-fadeIn" style={{ animationDelay: '1s' }}>
        <Card className="p-12 bg-gradient-to-br from-purple-600 to-blue-600 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of teams who trust MailWeaver for their bulk email needs. 
              Start sending personalized campaigns in minutes.
            </p>
            {status === 'loading' ? (
